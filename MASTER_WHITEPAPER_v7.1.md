...
11. [Section 9: Framework Evolution — Continuous Improvement](#section-9-framework-evolution)
...
|--------|--------|-------|-------------|
| **TOIL Ratio** | 83.9% (2023 peak) | 50.6% (2025) | -33.3 percentage points |
| **P95 Cycle Time** | 294.6 days | ~23 days | 92% reduction |
...
| Q2 2025 | 172 | 52.3% | -3.2 pts |
| Q3 2025 | 65 | 50.8% | -1.5 pts (worst) |
| Q4 2025 | 25 | **76.0%** | +25.2 pts (recovery) |

**Pattern:** Q1-Q3 decline followed by Q4 sharp recovery (+25 points), demonstrating the framework's ability to identify and address operational degradation through quarterly adaptation.
...
|-----------------|--------------|------------|
| "Goal is decreasing the TOIL" | 83.9% → 50.6% | 33.3pp reduction; Google <60% achieved |
